...
export function ContactSection() {
  ...
  const whatsappUrl =
    "https://wa.me/628118888000?text=Halo%20PT%20Inti%20Dinamis%2C%20saya%20ingin%20berkonsultasi%20mengenai%20kebutuhan%20pelatihan%20dan%20pengembangan%20SDM.";

  return (
    <section id="kontak" className="py-14 lg:py-20 bg-slate-50 border-t border-slate-200/80">

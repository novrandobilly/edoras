      ...
      <div className="relative min-h-145 sm:min-h-165 lg:min-h-185 flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 sm:pt-40 lg:pt-48 pb-32 sm:pb-36 lg:pb-40">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.12] drop-shadow-sm">
              <span className="block">Memberdayakan manusia,</span>
              <span className="block bg-linear-to-r from-red-500 via-red-600 to-rose-500 bg-clip-text text-transparent">
            ...
            <p className="mt-5 sm:mt-6 max-w-2xl text-sm sm:text-base md:text-lg text-slate-300 font-normal leading-relaxed">
              Kinerja tidak dimulai dari angka. Kinerja dimulai dari manusia
              yang mampu berpikir, mengambil keputusan, berkolaborasi, dan

...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-28 border-b border-slate-100">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-6 max-w-xl mx-auto text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
          Mentransformasi mindset, dinamika psikologis, dan modifikasi perilaku untuk mencapai
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/#kontak"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-8 py-3.5 text-sm sm:text-base font-bold text-white shadow-lg shadow-red-600/20 hover:bg-red-700 transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
          ...
          <Link
            href="/#produk-jasa"
            className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-8 py-3.5 text-sm sm:text-base font-semibold text-slate-700 hover:bg-slate-50 hover:text-slate-950 transition-colors shadow-xs"
          >
        ...
        <div className="mt-16 pt-8 border-t border-slate-100 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
          ...
          <div>
            <p className="text-3xl sm:text-4xl font-black text-red-600">7 Pilar</p>
            <p className="mt-1 text-xs font-medium text-slate-500">
              Layanan Terpadu
            </p>
          </div>

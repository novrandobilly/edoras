      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400 font-normal">
              PT Inti Dinamis adalah konsultan organisasi dan pengembangan sumber daya manusia yang
              berdiri sejak 2005. Kami berdedikasi menjadi mitra terbaik perusahaan dalam mengelola
              Human Capital menjadi kontributor hebat.
            </p>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xs font-bold uppercase tracking-widest text-white">Navigasi</h3>
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link href="/#tentang-kami" className="hover:text-red-400 transition-colors">
                  Tentang Kami
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/#pengalaman" className="hover:text-red-400 transition-colors">
                  Pengalaman Klien
                </Link>
              </li>
              <li>
                <Link href="/#galeri" className="hover:text-red-400 transition-colors">
                  Galeri Aktivitas
                </Link>
              </li>
              <li>
                <Link href="/#tim-ahli" className="hover:text-red-400 transition-colors">
                  Tim Ahli
                </Link>
              </li>
              <li>
                <Link href="/#kontak" className="hover:text-red-400 transition-colors">
                  Kontak Kami
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-3">
            <h3 className="text-xs font-bold uppercase tracking-widest text-white">Hubungi Kami</h3>
            <ul className="mt-4 space-y-3.5 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="h-4 w-4 shrink-0 text-red-500 mt-1" />
                <span className="text-slate-300">Jakarta & Surabaya, Indonesia</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 shrink-0 text-red-500" />
                <span className="text-slate-300">+62 (21) 555-0192 / 0811-8888-000</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-14 border-t border-slate-800/80 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            <span>&ldquo;Meningkatkan Kualitas Human Capital Menjadi Kontributor Hebat&rdquo;</span>
          </div>
        </div>
      </div>
    </footer>
